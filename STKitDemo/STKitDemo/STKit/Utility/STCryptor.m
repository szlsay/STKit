...
//    return [STCryptor AES128EncryptData:[string convertToNSData] withKey:key];
//}
//
//+ (NSData * _Nullable)AES128DecryptString:(NSString * _Nonnull)string withKey:(NSString * _Nonnull)key {
//    return [STCryptor AES128DecryptData:[string convertToNSData] withKey:key];
//}
//
//+ (NSData * _Nullable)AES256EncryptString:(NSString * _Nonnull)string withKey:(NSString * _Nonnull)key {
//    return [STCryptor AES256EncryptData:[string convertToNSData] withKey:key];
//}
//
//+ (NSData * _Nullable)AES256DecryptString:(NSString * _Nonnull)string withKey:(NSString * _Nonnull)key {
//    return [STCryptor AES256DecryptData:[string convertToNSData] withKey:key];
//}
